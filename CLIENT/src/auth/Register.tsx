...
export default function Register() {
  ...
  const signUp = async (e: { preventDefault: () => void }) => {
    ...
    if (username === "") {
      ...
      return setMessage("Username too short");
    }
    if (password === "") {
    ...
    if (confirm === "") {
      ...
      return setMessage("Password is not the same");
    }
      ...
      <div className="header bg-login bg-cover min-h-screen px-16">
        ...
        <div className="body flex justify-center">
          ...
          <div className="left flex justify-center lg:w-1/2 p-10">
            <div
              ref={cardRef}
              className="card flex flex-col border rounded-3xl bg-white w-[450px] justify-center items-center shrink-0 h-auto"
            >
              <div className="card-content">
                <h1 className="card-title font-bold text-black text-2xl mt-12">
                  Sign up to myE-commerce
                </h1>
                <div className="message-holder h-4 mb-4">
                ...
                <form className="flex flex-col gap-4" onSubmit={signUp}>
                  ...
                  <input
                    placeholder={usernameError ? "Empty Username" : "Username"}
                    className={`h-12 w-80 border ${
                      usernameError
                        ? "border-red-500 placeholder-red-400"
                        : "border-black-100"
                  ...
                  <input
                    type="password"
                    placeholder={passwordError ? "Empty Password" : "Password"}
                    className={`h-12 w-80 border ${
                      passwordError
                        ? "border-red-500 placeholder-red-400"
                        : "border-gray-200"
                ...
                <div className="register-link text-xs mt-4 text-gray-500">
                  ...
                  <div className="other-auth">Or Sign up with</div>
                  <div className="other-auth-container flex justify-between mt-5 mb-12">
                    <button>
                      <svg
